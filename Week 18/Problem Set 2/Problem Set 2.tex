...
\begin{document}
    ...
    \section{Topic B Problem 1}
        ...
        \subsection{Solution (a)}
            \begin{equation}
                \left[ \ce{Mg(NO3)2} \right]   =   \frac{m}{V}
                    =   \frac{4.18\,\unit{\gram}}{0.150\,\unit{\liter}}
                    =   \boxed{27.9\,\unit{\molarity}\,\ce{Mg(NO3)2}}
            \end{equation}

        \subsection{Solution (b)}
            \begin{equation}
                m   =   V * \left[ \ce{CaCl2} \right]
                    =   0.100\,\unit{\liter} * 1.08\,\unit{\molarity}\,\ce{CaCl2}
                    =   \boxed{0.108\,\unit{\gram}\,\ce{CaCl2}}
            \end{equation}
