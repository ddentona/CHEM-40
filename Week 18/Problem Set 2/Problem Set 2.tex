...
\begin{document}
    ...
    \section{Topic B Problem 10}
        ...
        \subsection{Solution (a)}
            The concentration of \ce{SnCl4} is a quarter of the concentration of \ce{Cl-}, since the ratio of \ce{SnCl4} to \ce{Cl-} is 4:1.
            \begin{gather}
    ...
    \section{Topic B Problem 12}
        ...
        \subsection{Solution}
            ...
            \begin{enumerate}[label=\alph*/]
                \item   Soluble (contains \ce{K+})
                \item   Soluble (contains \ce{NO3-})
                \item   Insoluble (\ce{S^2-} is insoluble with \ce{Fe^2+})
                \item   Soluble (contains \ce{Br-}, soluble wth \ce{Zn^2+})
                \item   Soluble (contains \ce{SO4^2-}, soluble with \ce{Mg^2+})
                \item   Soluble (contains \ce{HCO3-}, which contains \ce{CO3^2-}, soluble with \ce{Na+})
                \item   Insoluble (contains \ce{PO4^3-}, insoluble wth \ce{Ba^2+})
            \end{enumerate}
