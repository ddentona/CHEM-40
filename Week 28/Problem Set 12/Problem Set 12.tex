...
\begin{document}
    ...
    \section{Topic F Problem 11}
        ...
        \subsection{Solution}
            \begin{center}
                \includegraphics[width=\textwidth]{Answers Images/F11.jpg}
            \end{center}
    ...
    \section{Topic F Problem 12}
        ...
        \subsection{Solution}
            \begin{center}
                \includegraphics[width=\textwidth]{Answers Images/F12.jpg}
            \end{center}
    ...
    \section{Topic F Problem 16}
        ...
        \subsection{Solution}
            \begin{center}
                \includegraphics[width=\textwidth]{Answers Images/F16a.jpg}

                \includegraphics[width=\textwidth]{Answers Images/F16b.jpg}
            \end{center}
    ...
    \section{Topic F Problem 17}
        ...
        \subsection{Solution}
            \begin{center}
                \includegraphics[width=\textwidth]{Answers Images/F17a.jpg}

                \includegraphics[width=\textwidth]{Answers Images/F17b.jpg}
            \end{center}
    ...
    \section{Topic F Problem 18}
        ...
        \subsection{Solution}
            \begin{center}
                \includegraphics[width=\textwidth]{Answers Images/F18.jpg}
            \end{center}
    ...
    \section{Topic F Problem 19}
        \begin{wrapfigure}{r}{0.25\textwidth}
            \vspace{-30pt}
            \includegraphics[width=0.25\textwidth]{img-F19.png}
            % \label{fig:wrapfig}
        \end{wrapfigure}
        ...
        \subsection{Solution}
            \begin{center}
                \includegraphics[width=\textwidth]{Answers Images/F19.jpg}
            \end{center}
    ...
    \section{Topic F Problem 20}
        ...
        \subsection{Solution}
            \begin{center}
                \includegraphics[width=\textwidth]{Answers Images/F20.jpg}
            \end{center}
    ...
    \section{Topic F Problem 21}
        ...
        \subsection{Solution}
            \begin{enumerate}[label=\alph*/]
                \item   Eleven sigma bonds and four pi bonds.
                \item   One sp$^2$ (on Carbon) to sp$^2$ (on Nitrogen) in a Sigma bond. One 2p (on Nitrogen) to 2p (on Carbon) in a pi bond.
                \item   One sp (Carbon) to p (Nitrogen) in a sigma bond and two 2p to 2p in pi bonds.
                \item   In the double bonded Nitrogen, sp$^2$. In the triple bond Nitrogen, 2s.
            \end{enumerate}
